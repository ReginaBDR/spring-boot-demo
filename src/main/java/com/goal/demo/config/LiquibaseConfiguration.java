...
public class LiquibaseConfiguration {
    ...
    public SpringLiquibase liquibase(
        ...
        DataSource liquibaseDataSourceInstance = liquibaseDataSource.getIfAvailable();

        if (liquibaseDataSourceInstance != null) {
            liquibase.setDataSource(liquibaseDataSourceInstance);
        } else {
