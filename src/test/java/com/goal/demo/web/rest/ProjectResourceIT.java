...
class ProjectResourceIT {
    ...
    private static final ProjectStatus UPDATED_STATUS = ProjectStatus.ON_PROGRESS;
    ...
    void createProject() throws Exception {
        ...
        assertThat(testProject.getStateProvince()).isEqualTo(DEFAULT_STATE_PROVINCE);
    ...
    void putExistingProject() throws Exception {
        ...
        assertThat(testProject.getStateProvince()).isEqualTo(UPDATED_STATE_PROVINCE);
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).city(UPDATED_CITY).startDate(UPDATED_START_DATE);
